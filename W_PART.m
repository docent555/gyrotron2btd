function u = W_PART(sgn, fEND, fENDm1, SigmaEND, SigmaENDm1, dz, coeff_1i_m_C0_m_2_d_3_d_dt, coeff_1i_m_C0_d_3_d_dt)

u = sgn * dz * ((-coeff_1i_m_C0_m_2_d_3_d_dt) * fEND ...
    + (-coeff_1i_m_C0_d_3_d_dt) * fENDm1...
    - (2.0D0 * SigmaEND + SigmaENDm1));
